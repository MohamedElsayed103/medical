...
class PatientCreateSerializer(serializers.Serializer):
    ...
    national_id = serializers.CharField(max_length=50, required=False, default="", allow_blank=True)
    blood_type = serializers.CharField(max_length=5, required=False, default="", allow_blank=True)
    email = serializers.EmailField(required=False, allow_blank=True, default="")
    address = serializers.CharField(required=False, default="", allow_blank=True)
    emergency_contact_name = serializers.CharField(max_length=255, required=False, default="", allow_blank=True)
    ...
    insurance_provider = serializers.CharField(max_length=200, required=False, default="", allow_blank=True)
    insurance_number = serializers.CharField(max_length=100, required=False, default="", allow_blank=True)
